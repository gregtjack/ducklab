...
import { FileSpreadsheetIcon, Hash, Calendar, Binary, List, HelpCircle, ClockIcon, TypeIcon, TableIcon } from "lucide-react";
...
export function DatasetDetailsDialog({ dataset, isOpen, onClose }: DatasetDetailsDialogProps) {
    const { getTableSchema } = useCatalogStore();
                ...
                <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-sm">
                                {dataset.size > 0 ? prettyBytes(dataset.size) : 'Unknown'}
                            </p>
                        </div>
                        <div className="space-y-2">
                        ...
                        <div className="space-y-2">
                            ...
                            <span className={`inline-flex items-center rounded-md px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 ${dataset.isInsertable
                                    ...
                                    <TableBody>
                                        {schema.map((column) => (
                                            <TableRow key={column.columnName}>
                                                ...
                                                <TableCell>
                                                    <span className={`inline-flex items-center rounded-md px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 ${column.isNullable === 'YES'
